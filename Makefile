...
ALL                     += libvirt
libvirt-URL1           := http://libvirt.org/sources/libvirt-1.2.20.tar.gz
libvirt-URL2           := https://libvirt.org/sources/libvirt-1.2.20.tar.gz
libvirt-SHA1SUM        := f2c49d1f378382eb06529b9fe0ca555245701375
