...
ALL                     += libvirt
libvirt-URL1           := http://libvirt.org/sources/libvirt-1.2.8.tar.gz
libvirt-URL2           := http://mirror.onelab.eu/third-party/libvirt-1.2.8.tar.gz
libvirt-SHA1SUM        := 76dd3376abff73d297e183257eef4a71b9e5d5c8
