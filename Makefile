...
ALL                     += libvirt
libvirt-URL1           := http://libvirt.org/sources/libvirt-1.2.10.tar.gz
libvirt-URL2           := http://mirror.onelab.eu/third-party/libvirt-1.2.10.tar.gz
libvirt-SHA1SUM        := e83683cc59be7f60cbd62085d3d2284f595f5ed3
