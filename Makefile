...
ALL                     += libvirt
libvirt-URL1           := http://mirror.onelab.eu/third-party/libvirt-1.2.6.tar.gz
libvirt-URL2           := http://planet-lab.org/third-party/libvirt-1.2.6.tar.gz
libvirt-SHA1SUM        := f8a26fe2856435aca142dfdaf2172e08dc59d369
